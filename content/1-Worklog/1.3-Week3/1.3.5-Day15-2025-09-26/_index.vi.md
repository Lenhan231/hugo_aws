...
- EC2 và các loại instance; AMI, EBS, Instance Store.  
- Auto Scaling và mô hình giá EC2.  
- Dịch vụ liên quan: Lightsail, EFS, FSx.  
- Labs: (ghi chú các lab thực hiện trong tuần).
